...
/**
 * English language strings for local_calendarcategories.
 *
...
$string['calendarcategories:addevent'] = 'Link events to a calendar group';
...
$string['calendarcategories:view'] = 'View calendar group events';
...
$string['confirmleave'] = 'Do you really want to leave this calendar group?';
$string['currentmembers'] = 'Current members';
$string['currentmembersmatching'] = 'Current members matching "{$a}"';
$string['day_fri'] = 'Fri';
$string['day_mon'] = 'Mon';
$string['day_sat'] = 'Sat';
$string['day_sun'] = 'Sun';
...
$string['errorselfenrolnotallowed'] = 'This calendar group does not allow self-enrolment.';
...
$string['joinablecategories'] = 'Other calendar groups';
$string['joinablehint'] = 'These calendar groups allow self-enrolment.';
$string['joinbutton'] = 'Join';
$string['joinedcategory'] = 'You have joined the calendar group.';
$string['leavebutton'] = 'Leave';
$string['leftcategory'] = 'You have left the calendar group.';
$string['managecategories'] = 'Manage Calendar Groups';
$string['managemembers'] = 'Manage members';
$string['memberslink'] = 'Members';
...
$string['potentialmembers'] = 'Available users';
$string['potentialmembersmatching'] = 'Users matching "{$a}"';
$string['previousmonth'] = 'Previous month';
$string['privacy:metadata:local_calendarcategories_cats'] = 'Stores who last modified a category.';
$string['privacy:metadata:local_calendarcategories_cats:usermodified'] = 'ID of the user who last modified the category.';
$string['privacy:metadata:local_calendarcategories_members'] = 'Stores membership of a user in a calendar category.';
$string['privacy:metadata:local_calendarcategories_members:categoryid'] = 'ID of the calendar category.';
$string['privacy:metadata:local_calendarcategories_members:timecreated'] = 'Timestamp when the membership was created.';
$string['privacy:metadata:local_calendarcategories_members:userid'] = 'ID of the assigned user.';
$string['selfenrol'] = 'Allow self-enrolment';
$string['selfenrol_help'] = 'When enabled, users can add themselves to this calendar group and leave it again. Without this option, only administrators assign members.';
$string['showcategories'] = 'Show calendar groups';
$string['sortorder'] = 'Sort order';
$string['today'] = 'Today';
$string['toomanyusersmatch'] = 'Too many results. Please narrow your search.';
