...
/**
 * Deutschsprachige Zeichenketten für local_calendarcategories.
 *
...
$string['calendarcategories:addevent'] = 'Termine einer Kalendergruppe zuordnen';
...
$string['calendarcategories:view'] = 'Termine von Kalendergruppen anzeigen';
...
$string['confirmleave'] = 'Möchten Sie diese Kalendergruppe wirklich verlassen?';
$string['day_fri'] = 'Fr';
$string['day_mon'] = 'Mo';
$string['day_sat'] = 'Sa';
$string['day_sun'] = 'So';
...
$string['errorselfenrolnotallowed'] = 'Für diese Kalendergruppe ist kein Selbstbeitritt möglich.';
...
$string['joinablecategories'] = 'Weitere Kalendergruppen';
$string['joinablehint'] = 'Diese Kalendergruppen erlauben den Selbstbeitritt.';
$string['joinbutton'] = 'Beitreten';
$string['joinedcategory'] = 'Sie sind der Kalendergruppe beigetreten.';
$string['leavebutton'] = 'Verlassen';
$string['leftcategory'] = 'Sie haben die Kalendergruppe verlassen.';
...
$string['noupcoming'] = 'Keine bevorstehenden Termine in Ihren Kalendergruppen.';
...
$string['privacy:metadata:local_calendarcategories_cats'] = 'Speichert, welcher Nutzer eine Kategorie zuletzt geändert hat.';
$string['privacy:metadata:local_calendarcategories_cats:usermodified'] = 'ID des Nutzers, der die Kategorie zuletzt bearbeitet hat.';
$string['privacy:metadata:local_calendarcategories_members'] = 'Speichert die Zugehörigkeit eines Nutzers zu einer Kalender-Kategorie.';
$string['privacy:metadata:local_calendarcategories_members:categoryid'] = 'Die ID der Kalender-Kategorie.';
$string['privacy:metadata:local_calendarcategories_members:timecreated'] = 'Zeitstempel der Zuordnung.';
$string['privacy:metadata:local_calendarcategories_members:userid'] = 'Die ID des zugeordneten Nutzers.';
$string['selfenrol'] = 'Selbstbeitritt erlauben';
$string['selfenrol_help'] = 'Ist diese Option aktiviert, können sich Nutzerinnen und Nutzer selbst zu dieser Kalendergruppe hinzufügen und sie auch wieder verlassen. Ohne diese Option weist ausschließlich die Administration Mitglieder zu.';
$string['showcategories'] = 'Kalendergruppen anzeigen';
